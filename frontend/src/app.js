    ...
    configureRouter(config, router) {
        ...
        config.map([{
            ...
            //Home
            {
                ...
                title: "Bienvenidos a Training Center",
                settings: {
                    roles: ["visitor"] //deberían incluirse la vista para todos los roles
                }
            },
...
=======
      ...
      },
      {
        ...
        name: "specific-material",
        moduleId:
          "modules/material/specific-public-material/specific-public-material",
        title: "Material",
        settings: {
          roles: ["visitor"]
        }
...
>>>>>>> 2c62f948fe4be18e8207eaf751146e9a8c459250
